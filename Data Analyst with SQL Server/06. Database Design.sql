...
In the previous video, we learned about three different levels of data models: conceptual, logical, and physical.In the previous video, we learned about three different levels of data models: conceptual, logical, and physical.
...
Hint
For this first bullet, Marta's user role is called marta and the data scientist group role is called data_scientist. You'll need the GRANT and TO keywords.
