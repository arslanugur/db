...
This course will teach you the tools required to solve these questions. 
You will learn how to write recursive queries and query hierarchical data structures. 
To do this, you will use Common Table Expressions (CTE) and the recursion principle on a wide variety of datasets. 
You will, for example, dig into a flight plan dataset and learn how to find the best and cheapest connection between two airports. 
After completing this course, you will understand the principle of recursion, and be able to identify and create hierarchical data models.

1. Recursion and Common Table Expression (CTE)
In this chapter, you will learn about recursion and why it is beneficial to apply this technique. 
You will also refresh your knowledge about Common Expression Tables (CTE).


1.1. Recap of Common Table Expressions (CTE)
1.2. A CTE is ... Find the wrong fact!
...
1.4. A CTE for high-paid IT-positions
...
1.7. Calculate the factorial of 5
...
1.8. How to query the factorial of 6 recursively
...
1.9. Solve recursive maths problems
1.10. Counting numbers recursively
...
1.11. Calculate the sum of potencies
...
In this chapter, you will learn about recursive CTEs, how to query hierarchical datasets, 
and finally, how to apply recursive CTEs on hierarchical data.


2.1. Introduction to recursive CTE
2.2. Right or wrong?
...
2.3. Create the alphabet recursively
...
2.4. Create a time series of a year
...
2.5. Working with recursive queries
2.6. Who is your manager?
...
2.7. Get the hierarchy position
...
2.8. Which supervisor do I have?
...
2.9. Analyze the family tree
2.10. Get the number of generations?
...
2.11. Get all possible parents in one field?
...
In this chapter, you will learn how to create and modify database tables. 
You will learn about relational and hierarchical data models, how they differ, and when each model should be used.


3.1. How to work with tables
...
3.3. Inserting and updating a table
...
3.4. Deleting data and dropping table
...
3.5. Changing a table structure
...
3.6. Working with relational data models
3.7. Defining primary and foreign keys
...
3.8. Inserting data to person and order history
...
3.9. Getting the number of orders & total costs
...
3.10. Working with hierarchical data models
3.11. Creating a hierarchical data model
...
3.12. Networked and hierarchical models
...
3.13. Creating a networked data model
...
In this chapter, you will practice your learnings about hierarchical and recursive querying on real-world problems, 
such as finding possible flight routes, assembling a car, and modeling a power grid.
